    ...
    <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-16">
      <header>
        ...
        <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
          内容来自 GitHub Issues —— 在仓库里打了 <code className="rounded bg-black/[.06] px-1.5 py-0.5 font-mono dark:bg-white/[.08]">diary</code> 标签的 issue 会出现在这里。
        </p>
      </header>
      ...
      {errorMessage ? (
        ...
        <p className="mt-12 text-zinc-500 dark:text-zinc-400">
          还没有日记。去 GitHub 新建一个带 <code className="rounded bg-black/[.06] px-1.5 py-0.5 font-mono dark:bg-white/[.08]">diary</code> 标签的 issue 试试吧。
        </p>
      ) : (
